...
// with current positon of blank space
...
// defining queueDataStructure for maintaining visited and fringe lists.
...
void main()
{
	...
	initializeQueue(&q2);
	int i;
	printf("\nEnter the Initial State (Enter -1 for blank Tile): \n");
	inputState(&initialState);
	initializeState(&initialState);
	printf("\nEnter the Final State (Enter -1 for blank Tile): \n");
